...
- **Status:** Significant progress. The party reached the Gremory market in Brasboredon and obtained a **Zafiro Esmeralda** (Emerald Sapphire) from Berlin the goblin (Ch. 5). They still need to safely transport it to Lunei and administer the cure.
...
### 3. Survive the Battle of Brasboredon
- **Objective:** Regroup and reach the Mansion where Bixira is fighting. Escape or win the revolution.
- **Status:** Chaos has peaked. Nixira and Zacarías regrouped and fought through the inner gates, assisted by Donner IcePeak and a squad of dwarves. They obtained the emerald and funds from the market. **Bixira has opened a massive Dark Dimension portal** in the sky to intercept a falling meteor while fighting the General (Ch. 5). The party is now looking for a way to escape to "La Última Gota."
- **Stakes:** The city is under cataclysmic attack. A meteor is falling, and a dark portal dominates the sky. The General (Lv. 32) remains an avoided but existential threat.
...
- **Status:** After dying and returning from Val's realm, Zacarías spent "milenia" in a temporal scriptorium. This may have fulfilled or altered the Library's promise of power.
- **Questions:** What is the entity behind the voice? What power does it offer? What is the cost?

### Zacarías — Malacor's Betrayal
- **What:** Zacarías and Malacor were once close friends and brothers in faith. Something went wrong. Zacarías denies giving Malacor the Golden Crown.
- **Status:** Unresolved. No direct confrontation with Malacor yet.
- **Questions:** What happened between them? Did Zacarías actually give him the Crown? Why did Malacor turn?

### Zacarías — Malfas's Price
...
- **Status:** Relationship critical. After his death, Malfas (or Melfas) had to advocate for Zacarías's soul before Val. Zacarías's connection to his patron is now fragile and requires an "epic feat" to restore full favor (Ch. 5).
...
- **Status:** Identity exposed since Chapter 1. The presence of **Kali (daughter of Caledon)** in Brasboredon, using the "Heraldo de las Siete Canciones," suggests the Veil is actively operating in the city (Ch. 5).
...
- **Status:** Timer started in Chapter 2. Multiple in-game hours have passed. Urgency unclear — may need antivenom or healing.
...
- **Status:** Counter at 1/20. Zacarías also used a medallion to break a divine possession on Donner IcePeak (Ch. 5).
...
- **Status:** Active. However, the dwarf squad following Bixira and Donner seems more focused on the revolution for now, though tensions remain (Ch. 5).
...
- **What:** The stone invoker ripped off Zacarías's right hand during melee combat.
- **Status:** Likely restored. After dying and returning from the "Scriptorium" under Val's influence, Zacarías's physical form appears intact, though he is now marked by his journey to the afterlife (Ch. 5).
- **Questions:** How does Malfas react to Zacarías's new tie to Val? Does this change the pact terms?

### Zacarías — The Prophet Hunter
- **What:** Val, the Lord of Death, tasked Zacarías with finding and eliminating all "false prophets" who distort the faith.
- **Status:** Active. He witnessed the execution of Altaflama in the market (Ch. 5).
- **Questions:** Who are the other false prophets? What is Val's true goal for Zacarías?
...
- **Questions:** Was it connected to Malacor? To the Golden Crown? Did he commit an act that broke his oath? Was he betrayed by his god? Was the fall voluntary or forced?
- **Why it matters:** The nature of his fall defines his entire character arc — redemption, revenge, or acceptance.
...
- **Questions:** Who is she? Is she alive? Is she connected to the campaign? Is she the reason he left Dragonforce?
...
- **What:** In the cave, Zacarías's raven had to choose between a moonstone (10 platinum) and a compass. It took the moonstone. The compass vanished, relocated by a hidden mechanism.
...
- **Status:** His brother Donner IcePeak is currently with the party. Donner revealed there are **eight brothers** in total (Ch. 5).
...
- **Status:** The tavern is closed, but the gunpowder remains. A single spark could destroy the building.

### Dracus's Fate After the Ambush
- **What:** Was trying to free Tidus during Farquad's ambush at the cave exit.
- **Status:** Outcome unknown. Was he captured? Did he escape?

### The Fat Merchant
- **What:** Wealthy patron who called Dracus his "guardian." Fled with knowledge of the tavern incident.
- **Status:** At large. Could expose the party.

### Hook — Alone and Traumatized
- **What:** His twin Lock was disintegrated/teleported by the golden gate trap. Zacarías deceived him into believing Lock is fine.
- **Status:** With the refugees. Trusting the party — barely. When he learns the truth, the fallout could be severe.

### The Forbidden Chi-Astral Book
- **What:** Fuercitas stole it, getting the entire monk group imprisoned. The book is presumably still with the monks or confiscated.
- **Status:** Unresolved. What knowledge does it contain?

### Branig's Encounter
- **What:** The undead guard at the Prison Tortuga exit. He was mid-negotiation/dice-game with Nixira when the recording cut.
- **Status:** Outcome unknown (missing recording). The party got past him somehow.

### Robinson — Dead or Alive?
- **What:** Robinson was caught in a massive explosion outside the city walls.
- **Status:** Presumed dead by Nixira and Zacarías (Ch. 5).
- **Questions:** Did he survive the blast? Is he the "vago" mentioned near the market?

### Sniper — The Perfect Shot
- **What:** A legendary archer defending the district with explosive arrows. He killed Cory.
- **Status:** Active. Still positioned on the rooftops, though Donner has a ritual to target him (Ch. 5).
- **Questions:** How do they reach him? Can they bypass his explosive arrows?
...
### The Fallen Prince
- **What:** Victus's god tasked him with "destroying the Fallen Prince" and he failed. This figure is still out there.
- **Questions:** Who is the Fallen Prince? Is it Prince Robin (already dead)? Or someone else? Why did Victus fail?

### The Mysterious Woman
- **What:** Pale skin, crimson eyes, blood-red dress with frost-like sparkles. Appeared at the end of the Prison Tortuga segment.
- **Questions:** Who is she? Vampire? Dhampir? Ally or enemy? What was she doing in the prison?

### The Voice in the Arcane Library
...
- **Questions:** What darkness? Is this connected to the Grey Dream prophecy? What does Bhaal want from Tidus?
...
### The Eight Brothers
- **What:** Donner revealed that he and Lunei are part of eight brothers.
- **Questions:** Who are the others? Are they all involved in the current conflict?

### The Portal to the Dark Dimension
- **What:** Bixira opened a portal to the "Plano Oscuro" (Dark Dimension) to intercept a meteor.
- **Questions:** Can it be closed? What happens to those caught in its wake?
...
|--------|-----------|---------|
| **Kill the Bald Enemy** | Killed by Tidus (neck broken). Body consumed by summoned boa. | Ch. 1 |
| **Escape the Tavern** | Enemies killed or fled. Tavern closed. | Ch. 1 |
...
| **Altaflama (False Prophet)** | Killed by Donner in the market; body turned to ash. Zacarías claimed his Sacred Cape (+5 Religion damage). | Ch. 5 |
| **Cory (Dwarf Ally)** | Killed by a perfect headshot from the Sniper during the push to the market. | Ch. 5 |
| **Obtain Emerald for Lunei** | Obtained the **Zafiro Esmeralda** from Berlin the goblin in the Gremory market. | Ch. 5 |