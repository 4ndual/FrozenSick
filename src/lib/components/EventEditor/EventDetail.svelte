  ...
  <div class="detail-panel">
    <div class="detail-header">
      ...
      <div class="detail-actions">
        <button class="action-btn" onclick={() => ev && campaign.openEditor(ev)} title="Edit">
    ...
    <div class="detail-meta">
      <span class="meta-row">
        {#if cal.months[ev.date.month - 1]?.color}
          {@const m = cal.months[ev.date.month - 1]}
          <span
            class="month-dot"
            style="background: {m.color}"
            title={m.station ?? m.name}
          ></span>
        {/if}
