...
<div class="settings-section">
        ...
        {:else}
          <div class="tl-bar" style="border-left-color:{tl.color}">
            ...
            <div class="tl-actions">
              <button class="icon-btn" onclick={() => startEdit(tl)} title="Edit" aria-label="Edit {tl.name}" data-testid="track-edit-{tl.id}">
              ...
              <button
                ...
                data-testid="track-delete-{tl.id}"
  ...
  {:else}
    <button class="btn-add" onclick={() => { showAdd = true; }} data-testid="track-add">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="14" height="14">
